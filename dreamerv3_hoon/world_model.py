...
from dreamerv3_hoon.decoder import MLPDecoder
from dreamerv3_hoon.distribution import Dist
from dreamerv3_hoon.encoder import MLPEncoder
from dreamerv3_hoon.head import MLPHead
from dreamerv3_hoon.rssm import RSSM
...
class WorldModel(nn.Module):
    ...
    def setup(self):
        """Initializes a model."""
        # Encoder
        self.encoder = MLPEncoder(self.obs_shape, **self.encoder_kwargs)

        # RSSM
        self.rssm = RSSM(**self.rssm_kwargs)

        # Decoder
        self.decoder = MLPDecoder(self.obs_shape, **self.decoder_kwargs)
